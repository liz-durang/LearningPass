const uploadIPFS = async (data: any): Promise<any> => {
  const url = "https://ipfsapi-v2.vottun.tech/ipfs/v2/file/upload"; // Asegúrate de que la URL sea correcta
  ...
  try {
    const response = await fetch(url, {
      ...
      headers: {
        ...
        "x-application-vkn": `Bearer ${appId}`,
