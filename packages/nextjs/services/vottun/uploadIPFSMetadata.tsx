const uploadIPFSMetadata = async (data: any): Promise<any> => {
  const url = "https://ipfsapi-v2.vottun.tech/ipfs/v2/file/metadata"; // Asegúrate de que la URL sea correcta
...
export default uploadIPFSMetadata;
